...
(jQuery.easing.jswing = jQuery.easing.swing),
	jQuery.extend(jQuery.easing, {
		...
		easeInOutElastic: function(n, e, t, r, u) {
			...
			return 1 > e
				? -0.5 * (s * Math.pow(2, 10 * (e -= 1)) * Math.sin(((e * u - a) * (2 * Math.PI)) / i)) + t
				: s * Math.pow(2, -10 * (e -= 1)) * Math.sin(((e * u - a) * (2 * Math.PI)) / i) * 0.5 + r + t;
		},
		...
		easeInOutBounce: function(n, e, t, r, u) {
			return u / 2 > e ? 0.5 * jQuery.easing.easeInBounce(n, 2 * e, 0, r, u) + t : 0.5 * jQuery.easing.easeOutBounce(n, 2 * e - u, 0, r, u) + 0.5 * r + t;
		}
	});
	...
	(function(t, e) {
		...
		return (
			...
			(i.prototype._getItemLayoutPosition = function(t) {
				...
				for (
					var o = this._getColGroup(n), s = Math.min.apply(Math, o), r = o.indexOf(s), a = { x: this.columnWidth * r, y: s }, u = s + t.size.outerHeight, h = this.cols + 1 - o.length, d = 0;
					d < h;
					d++
				)
					this.colYs[r + d] = u;
